            ...
            @else
                @foreach($products as $key => $line)
                    ...
                    <div class="item_list @if(!$product->active) active_item_{!! App::getLocale() !!} @endif col-lg-3 col-md-4 col-sm-4">
                        ...
                        ?>
                        <a href="{!! route('products_show', ['category'=>'dog','url'=>$product->url] ) !!}">
                            <div class="product_item">
                                ...
                                <div class="product-item__more">
                                    <a href="{!! route('products_show', ['category'=>'dog','url'=>$product->url] ) !!}" class="product-item__more-link">{{ trans('products.more')}}</a>
                                </div>
                            </div>
                        </a>
                    </div>
